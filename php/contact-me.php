...
if($_POST) {
    ...
    $to_Email = 'talbi.bus@gmail.com'; // Write your email here to receive the form submissions
    $subject = 'New message from WohlFuhlen'; // Write the subject you'll see in your inbox
